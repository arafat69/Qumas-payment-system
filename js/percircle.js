  ...
  function (t, e, r) {
    ...
    r(2),
      (a.fn.percircle = function (t) {
        var e = [],
          r = a.extend({}, { animate: !0 }, t);
        return (
          a(window).scroll(function (t) {
            a.each(e, function (t, e) {
              e.completed ||
                (o(e.instance) &&
                  ((e.completed = !0), a(e.instance).percircle(e.options)));
            });
          }),
          this.each(function () {
            ...
            var d, c, l;
            t.hasClass("percircle") || t.addClass("percircle"),
              void 0 !== t.attr("data-animate") &&
                (r.animate = "true" == t.attr("data-animate")),
              r.animate && t.addClass("animate"),
              void 0 !== t.attr("data-animateOnView") &&
                (r.animateOnView = "true" == t.attr("data-animateOnView")),
              void 0 !== t.attr("data-progressBarColor") &&
                (r.progressBarColor = t.attr("data-progressBarColor")),
              (d = { "border-color": r.progressBarColor }),
              (c = a(this)),
              (l = r.progressBarColor),
            ...
            var f = t.attr("data-percent") || r.percent || 0,
              u = t.attr("data-perclock") || r.perclock || 0,
            ...
            if (
              (r.animate &&
                ...
                !o(this) &&
                !i &&
                (e.push({ instance: this, options: r }), (f = 0)),
              f || r.displayTextAtZero)
            ) {
              ...
              t.html("<span>" + p + "</span>"),
                ...
                a(".slice .bar, .slice .fill", t).css(d),
                f > 50 &&
                  a(".bar", t).css({
    ...
    var o = function (t) {
        return (
          a(t).offset().top + a(t).height() <
          a(window).scrollTop() + a(window).height()
        );
      },
      n = function (t, e, r) {
        var o,
          n = t.attr("data-secs") || e.secs,
          s = t.attr("data-timeUpText") || e.timeUpText,
          i = t[0].hasAttribute("data-reset") || e.reset;
        function d() {
          if (
            ((n -= 1) > 30 && t.addClass("gt50"),
            n < 30 && t.removeClass("gt50"),
            f(),
            n <= 0)
          )
            return l(), void t.html("<span>" + s + "</span>");
        }
        function c() {
          o = setInterval(d, 1e3);
        }
